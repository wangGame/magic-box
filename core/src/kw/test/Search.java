    ...
    int verify(String facelets) {
        ...
        try {
            String center = new String(
                new char[] {
                    facelets.charAt(Util.U5), //4
                    facelets.charAt(Util.R5), //13
                    facelets.charAt(Util.F5), //22
                    facelets.charAt(Util.D5), //31
                    facelets.charAt(Util.L5), //40
                    facelets.charAt(Util.B5)  //49
                }
            );
            //此种颜色对应的中间是哪一个
            for (int i = 0; i < 54; i++) {
